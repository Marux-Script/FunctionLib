...
function Library:CreateWindow(Config, Parent)
	...
	function WindowInit:CreateTab(Name)
		...
		function TabInit:CreateSection(Name)
			...
			function SectionInit:AddTextBox(Name, PlaceHolder, NumbersOnly, Callback)
				local TextBoxInit = {}
			...
			function SectionInit:AddToggle(Name, Default, Callback)
				...
				function ToggleInit:AddKeybind(Bind,Callback)
					local KeybindInit = {}
					Bind = Bind or "NONE"
			...
			function SectionInit:AddDropdown(Name, OptionTable, Callback, InitialValue)
				local DropdownInit = {}
